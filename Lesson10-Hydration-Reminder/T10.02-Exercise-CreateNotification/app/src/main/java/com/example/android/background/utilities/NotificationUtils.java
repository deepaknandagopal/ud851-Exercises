...
import com.example.android.background.BuildConfig;
...
public class NotificationUtils {
    ...
    private static final int WATER_REMAINDER_PENDING_INTENT_ID = 886;
    private static final String WATER_REMAINDER_NOTIFICATION_CHANNEL_ID = "remainder_notification_channel";
    private static final int WATER_REMAINDER_NOTIFICATION_ID = 270;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(context, WATER_REMAINDER_NOTIFICATION_CHANNEL_ID).setColor(ContextCompat.getColor(context, R.color.colorPrimary))
        ...
        manager.notify(WATER_REMAINDER_NOTIFICATION_ID, notificationBuilder.build());
    }
