...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String rawJSON = "rawJSON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            mUrlDisplayTextView.setText(savedInstanceState.getString(queryURL).toString());
            mSearchResultsTextView.setText(savedInstanceState.getString(rawJSON).toString());
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(rawJSON, results);
    }
