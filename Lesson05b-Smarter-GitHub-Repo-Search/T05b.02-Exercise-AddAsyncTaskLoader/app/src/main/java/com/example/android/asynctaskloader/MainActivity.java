...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int  GITHUB_SEARCH_LOADER = 120;
    ...
    private void makeGithubSearchQuery() {
        ...
        Loader<String> loader = loadmanager.getLoader(GITHUB_SEARCH_LOADER);
        if(loader == null)
        {
            loadmanager.initLoader(GITHUB_SEARCH_LOADER,queryBundle,this);
        }
        else
        {
            loadmanager.restartLoader(GITHUB_SEARCH_LOADER,queryBundle,this);
        }
